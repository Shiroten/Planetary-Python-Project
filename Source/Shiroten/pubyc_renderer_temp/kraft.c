...
#define __PYX_HAVE__kraft
#define __PYX_HAVE_API__kraft
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
#include <stdio.h>
...
#define __Pyx_MODULE_NAME "kraft"
extern int __pyx_module_is_main_kraft;
int __pyx_module_is_main_kraft = 0;

/* Implementation of 'kraft' */
...
static void __pyx_f_5kraft_Kraft(__Pyx_memviewslice __pyx_v_masse_view, __Pyx_memviewslice __pyx_v_abstand_view, __Pyx_memviewslice __pyx_v_Betrag, int __pyx_v_head, int __pyx_v_tail, __Pyx_memviewslice __pyx_v_result) {
  double __pyx_v_g1;
  double __pyx_v_g2;
  double __pyx_v_g3;
  double __pyx_v_G;
 ...
 */
  __pyx_t_4 = 0;
  if (__pyx_t_4 < 0) __pyx_t_4 += __pyx_v_abstand_view.shape[0];
  __pyx_t_5 = 0;
  if (__pyx_t_5 < 0) __pyx_t_5 += __pyx_v_result.shape[0];
  *((double *) ( /* dim=0 */ (__pyx_v_result.data + __pyx_t_5 * __pyx_v_result.strides[0]) )) = ((__pyx_v_G * (__pyx_v_masse_multyply / __pyx_v_betrag)) * (*((double *) ( /* dim=0 */ (__pyx_v_abstand_view.data + __pyx_t_4 * __pyx_v_abstand_view.strides[0]) ))));
 ...
 */
  __pyx_t_6 = 1;
  if (__pyx_t_6 < 0) __pyx_t_6 += __pyx_v_abstand_view.shape[0];
  __pyx_t_7 = 1;
  if (__pyx_t_7 < 0) __pyx_t_7 += __pyx_v_result.shape[0];
  *((double *) ( /* dim=0 */ (__pyx_v_result.data + __pyx_t_7 * __pyx_v_result.strides[0]) )) = ((__pyx_v_G * (__pyx_v_masse_multyply / __pyx_v_betrag)) * (*((double *) ( /* dim=0 */ (__pyx_v_abstand_view.data + __pyx_t_6 * __pyx_v_abstand_view.strides[0]) ))));
 ...
 */
  __pyx_t_8 = 2;
  if (__pyx_t_8 < 0) __pyx_t_8 += __pyx_v_abstand_view.shape[0];
  __pyx_t_9 = 2;
  if (__pyx_t_9 < 0) __pyx_t_9 += __pyx_v_result.shape[0];
  *((double *) ( /* dim=0 */ (__pyx_v_result.data + __pyx_t_9 * __pyx_v_result.strides[0]) )) = ((__pyx_v_G * (__pyx_v_masse_multyply / __pyx_v_betrag)) * (*((double *) ( /* dim=0 */ (__pyx_v_abstand_view.data + __pyx_t_8 * __pyx_v_abstand_view.strides[0]) ))));
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "kraft._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_kraft(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_kraft},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initkraft(void); /*proto*/
PyMODINIT_FUNC initkraft(void)
#else
PyMODINIT_FUNC PyInit_kraft(void); /*proto*/
PyMODINIT_FUNC PyInit_kraft(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_kraft(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_kraft(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("kraft", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_kraft) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(1, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "kraft")) {
      if (unlikely(PyDict_SetItemString(modules, "kraft", __pyx_m) < 0)) __PYX_ERR(1, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("Kraft", (void (*)(void))__pyx_f_5kraft_Kraft, "void (__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int, __Pyx_memviewslice)") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  /*--- Type init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init kraft", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init kraft");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
